...
class RotateAnimatedText extends AnimatedText {
  ...
  @override
  Widget completeText(BuildContext context) => rotateOut ? const SizedBox.shrink() : super.completeText(context);

  @override
  Widget animatedBuilder(BuildContext context, Widget? child) {
    final fontSize = textStyle?.fontSize ?? DefaultTextStyle.of(context).style.fontSize;
