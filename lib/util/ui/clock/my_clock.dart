...
class _AnalogClockState extends State<AnalogClock> {
  ...
  // _AnalogClockState(datetime) : datetime = datetime ?? DateTime.now();
  ...
  initState() {
    ...
    if (widget.isLive) {
      ...
      Duration updateDuration = widget.showSecondHand ? const Duration(seconds: 1) : const Duration(minutes: 1);
